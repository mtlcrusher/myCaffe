...
train_lmdb = '/content/data_dog_cat/train_lmdb'
validation_lmdb = '/content/data_dog_cat/validation_lmdb'

os.system('rm -rf  ' + train_lmdb)
os.system('rm -rf  ' + validation_lmdb)


train_data = [img for img in glob.glob("/content/data_dog_cat/train/*jpg")]
test_data = [img for img in glob.glob("/content/data_dog_cat/test1/*jpg")]
